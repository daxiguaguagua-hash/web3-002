          ...
          {MOCK_FAMILY_MEMBERS.map((member) => (
            <div key={member.id} className="shrink-0 w-[140px] bg-white rounded-xl p-4 flex flex-col items-center gap-3 shadow-sm border border-slate-100 relative">
              ...
              <div className="text-center">
                ...
                <p className={`text-[10px] font-bold uppercase tracking-wider mt-1 px-2 py-0.5 rounded-full ${member.role === 'Admin' ? 'text-mint bg-mint/10' : 'text-muted bg-slate-100'}`}>
                  {member.role}
                </p>
              </div>
            </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm overflow-hidden border border-slate-100">
          <div className="p-4 flex items-center justify-between border-b border-slate-50">
            <div className="flex items-center gap-4">
              <div className="w-10 h-10 rounded-xl bg-slate-50 flex items-center justify-center text-slate-500"><EyeOff size={22} /></div>
          ...
          <div className="p-4 flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className="w-10 h-10 rounded-xl bg-mint/10 flex items-center justify-center text-mint"><Wallet size={22} /></div>
              <div className="flex flex-col">
